Imports BlueprintMerge.Encryption
...
Public Class LicKey
	...
	Public Sub New()
		...
		Serial.CompanyName = ""
		SecretSalt = "Test"
		SecretKey = GenKey(SecretSalt & "DESLicenseKeyGenPASSw0rd!", 256)
	End Sub

#Region "Properties"
	Property strCompanyName As String
		Get
			Return Serial.CompanyName
		End Get
		Set(value As String)
			Serial.CompanyName = value
		End Set
	End Property
...
#End Region
	...
	Private Function DecryptSerial(ByVal KeyCode As String) As SerialInf
		...
		Try
			Dim sym As New Encryption.Symmetric(Symmetric.Provider.Rijndael)
